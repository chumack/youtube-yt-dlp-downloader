...
- Аудиодорожка: оригинал, дубляж на выбранном языке, либо дубляж+оригинал
  в одном MKV-файле (дубляж — первой дорожкой). После поиска одиночного видео список реально доступных
  языков подставляется автоматически; дубляж есть только там, где его загрузил автор.
